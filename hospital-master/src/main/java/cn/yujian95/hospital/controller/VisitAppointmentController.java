...
import cn.yujian95.hospital.entity.StaticsVo;
...
public class VisitAppointmentController {
    ...
    @ApiOperation(value = "通过科室查看就诊人数统计", notes = "")
    @RequestMapping(value = "/appointment/getAppointmentBySpecial", method = RequestMethod.GET)
    public CommonResult getAppointmentBySpecial() {
        Map<String, Object> map = appointmentService.getAppointmentBySpecial();
        return CommonResult.success(map);
    }

    //查询就诊卡性别统计
    @GetMapping("/appointment/qryUserStatisGroupBySex")
    public CommonResult qryUserStatisGroupBySex(){
        List<StaticsVo> list = appointmentService.qryUserStatisGroupBySex();
