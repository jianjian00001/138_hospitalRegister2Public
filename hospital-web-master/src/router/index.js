    ...
    children: [
      {
        path: "/appointDetail",
        component: () =>
          import("@/view/patientManagement/appointDetail/appointDetail"),
        meta: { title: "预约详情", icon: "el-icon-user" }
      },
      {
        path: "/patientMedicalRecord",
        component: () =>
          import("@/view/patientManagement/appointDetail/patientMedicalRecord"),
        meta: { title: "患者详情", icon: "el-icon-user" },
        hidden: true
      }
    ]
    ...
    children: [
      {
        ...
        component: () =>
          import(
            "@/view/departmentManagement/departmentDetail/departmentDetail"
          ),
        meta: { title: "专科详情", icon: "el-icon-user" }
      },
      {
        path: "/departmentSetUp",
        component: () =>
          import("@/view/departmentManagement/departmentSetUp/departmentSetUp"),
        meta: { title: "专科排班", icon: "el-icon-user" }
      },
      {
        path: "/outpatientDetail",
        component: () =>
          import(
            "@/view/departmentManagement/departmentDetail/outpatientDetail"
          ),
        meta: { title: "门诊详情", icon: "el-icon-user" },
        hidden: true
      },
      {
        ...
        component: () =>
          import(
            "@/view/departmentManagement/departmentDetail/treatRoomDetail"
          ),
        meta: { title: "诊室详情", icon: "el-icon-user" },
        hidden: true
      },
      {
        path: "/outpatientSetUp",
        component: () =>
          import("@/view/departmentManagement/departmentSetUp/outpatientSetUp"),
        meta: { title: "门诊排版", icon: "el-icon-user" },
        hidden: true
      }
    ]
