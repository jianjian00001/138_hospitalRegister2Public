...
// 7、根据科室查询预约人数
export function getAppointmentBySpecial() {
  return request({
    url: "/visit/appointment/getAppointmentBySpecial",
    method: "get"
  });
}
// 8、查询就诊卡性别统计
export function qryUserStatisGroupBySex() {
  return request({
    url: "/visit/appointment/qryUserStatisGroupBySex",
    method: "get"
  });
}
