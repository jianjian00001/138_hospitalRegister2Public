...
public class HospitalDoctorController {
    ...
    @ApiOperation(value = "获取医生信息", notes = "传入医生名")
    @RequestMapping(value = "/getDoctorByUserName/{id}", method = RequestMethod.GET)
    public CommonResult<HospitalDoctorDTO> getDoctorByUserName(@PathVariable String userName) {

        Optional<HospitalDoctorDTO> doctorOptional = doctorService.getConvert2(userName);
