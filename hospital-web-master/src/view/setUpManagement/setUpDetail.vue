...
export default {
  ...
  methods: {
    ...
    // 删除列表中的某一条数据
    deleteData: function() {
      deleteOutCallById(this.deleteScope.scopeRow.ID)
        .then(res => {
          if (res.code === 200) {
    ...
    getTreatRoom: function() {
      ...
      getTreatRoom(this.selectOutpatientID, 1, 100)
        .then(res => {
          if (res.code === 200) {
